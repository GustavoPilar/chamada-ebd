...
import { AfterViewInit, ChangeDetectorRef, Component, HostListener, Inject, Input, OnChanges, OnDestroy, OnInit, SimpleChanges, ViewChild, ViewContainerRef } from "@angular/core";
...
export class CrudListComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  public ngOnInit(): void {
    ...
    this.optionTypes = [
      { description: "Tabela", icon: PrimeIcons.LIST, value: false },
      { description: "Grid", icon: PrimeIcons.OBJECTS_COLUMN, value: true },
    ]
